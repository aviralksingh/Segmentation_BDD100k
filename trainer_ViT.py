...
# Add the path to the models folder
...
class Trainer:
    ...
    def __init__(self, model, optimizer, loss_fn,config, exp_name, device):
...
def parse_args():
    ...
    parser.add_argument("--save-model-every", type=int, default=10)
...
def main():
    ...
    trainer = Trainer(model, optimizer, loss_fn, config, args.exp_name, device=device)
